...
public:
  ...
  using ApplyFunc = std::function<void(const std::string &)>;
  ...
  /** Set callback to apply committed log commands. */
  void setApplyCallback(ApplyFunc cb) { applyFunc = std::move(cb); }
