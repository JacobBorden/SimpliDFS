...
1. Clone the repository:
   ...
   cd SimpliDFS
   ```
2. Run the setup script to install dependencies. It checks your
   installed `protoc` and automatically installs Protobuf 3.21.12 if it
...
3. If you built a previous revision, remove the old `build` directory and any
   ...
   ```
4. Verify your `protoc` version is at least 3.21.12:
   ```sh
   protoc --version
   ```
